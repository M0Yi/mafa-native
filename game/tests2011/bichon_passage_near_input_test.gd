...
func run() -> void:
	...
	app.enter_map("0",Vector2i(307,313));app._process(0)
	...
	FileAccess.open("res://../artifacts/world-story/bichon-passage-near-input.json",FileAccess.WRITE).store_string(JSON.stringify(report,"\t"));print(JSON.stringify(report))
